...
void Lab4::Update(float deltaTimeSeconds)
{
    ...
    //bonus
    radius += deltaTimeSeconds * 2;
    translateSunX += deltaTimeSeconds * 0.5;
    translateSunZ -= deltaTimeSeconds * 0.2;


    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(translateSunX, translateSunY, translateSunZ);
    modelMatrix *= transform3D::RotateOY(radius);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(translateSunX, translateSunY, translateSunZ);
    modelMatrix *= transform3D::RotateOY(radius / 2);
