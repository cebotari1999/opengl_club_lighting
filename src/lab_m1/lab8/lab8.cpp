...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    //    RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.95, 0.15, 0.35));
    ...
    //    // TODO(student): Add or change the object colors
    //    RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.15, 0.45, 0.35));
    ...
    //    RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.25, 0.75, 0.95));
    //}
    ...
    //        // TODO(student): Add or change the object colors
    //        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.15, 0.15, 0.95));
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_1)) cutOff += 1;
        if (window->KeyHold(GLFW_KEY_2)) cutOff -= 1;
